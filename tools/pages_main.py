  ...
  <div class="ebook-body">
    ...
    <div class="wrap">
      <div class="sec-head">
        ...
        <p class="sec-note muted">Start with the free guide. Then learn the complete workflow — real page spreads from inside the book below (4 real interior images coming soon).</p>
      </div>
